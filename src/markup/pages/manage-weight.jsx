...
class manageWeight extends Component {
    ...
    render() {
        const title = "Best Weight Loss centre |Weight management in Bangalore - Bridge health";
        const description = "Best doctors for weight loss diet counseling in Bangalore. Get personalized diet plans & expert guidance. Book online appointment for weight loss treatment in Bangalore.";
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="sec-title squrebox">
                                    ...
                                    <p className='font22'>
                                        Weight management is vital for maintaining good health. Failing to manage one's weight can
                                        lead to a range of health problems and complications, including an
                                        increased risk of heart disease, stroke, and diabetes. Obesity is linked to a higher risk of
                    ...
                    <div class="auto-container">
                        <div class="row align-items-center reverseFlex">
                            <div class="col-lg-6">
                                <div class="sec-title squrebox">
                                    <p className='font22'>
                                        Conversely, being underweight can lead to malnutrition, a weakened immune system, and
                                        osteoporosis. In addition to physical health issues, improper weight management can also
                                        have an impact on mental health and wellbeing, including depression, anxiety, and low
                                        self-esteem.
                                        It is important to take weight management seriously and seek support from healthcare
                                        professionals to help prevent these potential health problems.
                                    </p>
                                </div>
                                <div class="btn-box text-center btn5">
                                    <ContactForm buttonText="BOOK NOW" popupPosition="right" />
                            ...
                            <div class="col-lg-6">
                                ...
                                <img src={require('../../assets/images/shape/mweight.png')} alt=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="sec-title squrebox">
                                    {/* <h2> <span className='headeingcolorblack1'>YOU ARE WHAT YOU EAT</span></h2> */}
                                    <p className='font22'>
                                        Diabetes is a chronic condition that affects millions of people worldwide. If left untreated
                                        or improperly managed, it can lead to a range of complications,
                                        including nerve damage, blindness, kidney disease, and heart disease. Therefore, proper
                                        diabetes care is essential for maintaining good health and preventing these complications.
                                    </p>
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <ul className='listicon'>
                                        ...
                                        <li>
                                            Develop personalized weight management plan based on goals, lifestyle, and medical
                                            history
                                        </li>
                                        <li>
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <ul className='listicon'>
                                        ...
                                        <li>
                                            Identify and address emotional or behavioural issues that may be underlying causes for
                                            weight issues
                                        </li>
