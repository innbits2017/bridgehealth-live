                    ...
                    <div class="contact-form-area">
                        ...
                        <div class="sec-title squrebox">
                            <p className='font22'>
                                ...
                                hypertension can lead to serious health problems such as heart disease, stroke, kidney
        ...
        <div class="auto-container">
            <div class="row align-items-center reverseFlex">
                <div class="col-lg-6">
                    <div class="sec-title squrebox">
                        <p className='font22'>
                            Fortunately, hypertension can be effectively managed with the right care, including
                            lifestyle changes and medication when necessary.
                            By prioritizing hypertension management, individuals can significantly reduce their risk of
                            developing serious health problems and improve their overall health and well-being
                        </p>
                    </div>
                    <div class="btn-box text-center btn5">
                        <ContactForm buttonText="BOOK NOW" popupPosition="right" />
                ...
                <div class="col-lg-6">
                    <img src={require('../../assets/images/shape/tension3.png')} alt=""
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="martop">
                        <div class="sec-title">
                            <p className='font22'>
                                At Bridge Health, we understand how important it is to manage hypertension to prevent
                                serious health problems. That's why our team of healthcare professionals works with each
                                individual to create a
                                personalized management plan that includes lifestyle modifications, like diet and
                                exercise, as well as medication when needed. Using the latest technology and tools, we
                                closely monitor blood pressure readings and provide ongoing support to help individuals
                                achieve their goals.
                            </p>
                        </div>
                        <div class="btn-box text-center btn5">
            ...
            <div class="row align-items-center reverseFlex">
                <div class="col-lg-6">
                    <div class="sec-title squrebox">
                        ...
                        <p className='font22'>
                            Our hypertension management program is designed to empower individuals to take control of
                            their health and reduce their risk of developing serious health problems.
                            With Bridge Health, individuals can feel confident that they have the resources and support
                            they need to effectively manage their hypertension and improve their overall health and
                            well-being
                        </p>
                    </div>
                    <div class="btn-box text-center btn5">
                ...
                <div class="col-lg-6">
                    <div class="contact-form-area">
                        <ul className='listicon'>
                            <li>
                                Develop a personalized management plan that includes lifestyle modifications and
                            ...
                            <li>
                                Encourage regular follow-up appointments to track progress and make any necessary
                                adjustments to the management plan
                            </li>
                            <li>
                                Collaborate with other healthcare providers to provide comprehensive care to patients
                                with hypertension
                            </li>
                ...
                <div class="col-lg-6">
                    <div class="contact-form-area">
                        <ul className='listicon'>
                            ...
                            <li>
                                Refer patients to specialists when needed, such as dietitians, exercise specialists, or
                                cardiologists
                            </li>
                            <li>
                                Educate patients on the importance of managing hypertension and the potential health
                                risks associated with uncontrolled hypertension
                            </li>
                            <li>
                                Empower patients to take an active role in their hypertension management and encourage
                                them to ask questions and share concerns
                            </li>
