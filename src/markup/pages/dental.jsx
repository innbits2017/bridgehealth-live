...
class dental extends Component {
    ...
    render() {
        const title = "Best Dental Consultations in Bangalore |Book Online - Bridge Health";
        const description = "Best dental consultations at Bridge Health with skilled dental professionals provide personalized care, expert advice, & a wide range of dental services in Bangalore.";
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <div class="sec-title squrebox">
                                        <p className='fontimp'>
                                            Our teeth are made of enamel which is the hardest substance in the human body. Unhealthy
                                            food items like sugary carbonated drinks and candies weaken our enamel which causes a
                                            variety of problems including tooth decay.
                                        </p>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="contact-form-area">
                                ...
                                <div class="sec-title squrebox">
                                    ...
                                    <p className='font22'>
                                        It’s time to give your teeth the care they deserve. At Bridge Health, we provide dental
                                        consultations with experts who understand what your teeth need to stay strong and healthy.
                                        Our practitioners have several years of experience and are trained to perform a variety of
                                        different dental procedures so that all your dental needs are met.
                                    </p>
                                </div>
                                <div class="btn-box text-center btn5">
                                    {/* <button class="commonBtnforAll">BOOK NOW</button> */}
