...
class psychological_Health extends Component {
    ...
    render() {
        const title = "Best Psychological Health in Bangalore - Book Appointment | Bridge Health";
        const description = "Bridge Health, the leading mental health provider in Bangalore. Mental health is extremely important in the current times due to increased work & social pressures. Talk to our expert clinical psychologists.";
