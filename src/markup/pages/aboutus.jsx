...
class aboutUs extends Component {
    ...
    render() {
        const title = "Personalized Care Continuum -Medical & Digital Health Services |Bridge Health";
        const description = "Bridge Health is one stop health solution for all preventive & holistic healthcare with personalized annual health plans. & There is a plan to fit the specific health needs of everybody - your spouse, parents, kids & YOU. Know more about Bridge Health, JP Nagar 2nd phase Bangalore ";
                    ...
                    <div class="row align-items-center reverseFlex">
                        ...
                        <div class="col-lg-6">
                            <div class="sec-title squrebox">
                                ...
                                <p className='font22'>
                                    <span className='headeingcolorblue'> Bridge Health</span> is an integrated Medical & Digital
                                    Healthcare program designed to deliver Individualized Care Continuum proactively. This program
                                    is executed through well-curated and validated clinical protocols.
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="contact-form-area">
                                ...
                                <div class="sec-title squrebox">
                                    <p className='font22'>
                                        With our in-house specialized clinical and support team along with our credentialed
                                        affiliate partners,
                                        we have put together a personalized physical and digital ecosystem for your continued
                                        wellbeing.
                                        The promise this program delivers is to make available a comprehensive and continuing
                                        Healthcare Companionship that is personalized for you and your family. While the program is
                                        predicated on prevention,
                            ...
                            <div class="col-lg-5">
                                <div class="contact-form-area">
                                    ...
                                    <div class="sec-title squrebox">
                                        {/* <h2> <span className='headeingcolorblack1'>YOU ARE WHAT YOU EAT</span></h2> */}
                                        <p className='font22'>
                                            We, at Bridge Health, believe that a proactive focus on personalized healthcare and
                                            swift curative actions to mitigate risks are of paramount importance to each one of us.
                                            Our journey is all about being your trusted <span className='headeingcolorblue'>
                                                “Healthcare Companion for Life”.</span>
                                        </p>
                    ...
                    <div class="auto-container">
                        <div class="sec-title text-center">
                            <h2> <span className='headeingcolorblue'>REACH </span> <span className='headeingcolorblack'>OUT TO
                                US</span><br></br>
                                <p style={{ fontSize: 22 + 'px' }}>There is a plan to fit the specific health needs of everybody -
                                    your spouse, parents, kids & YOU! <br></br> <span className='headeingcolorblue'>Talk to our
                                        health advisor today!!</span></p>
                            </h2>
                        </div>
