...
class yoga_Assessment extends Component {
    ...
    render() {
        const title = "Best Yoga Centre in Bangalore| Certified Yoga Expert - Bridge Health";
        const description = "Best yoga therapy at Bridge Health. Experience tailored yoga programs with award-winning yoga trainers in Bangalore. Book your sessions now.";
                        ...
                        <div class="content-box">
                            ...
                            <div class=" text-center textleft">
                                ...
                                <h2 className='textleft fontSize'>
                                    <span className='headeingcolorblack'> Unite your </span> <span className='headeingcolorblue'>
                                        Mind,
                                        Body & Soul</span>
    ...
    <b2c_page /> */}
                ...
                <section class="contact-section">
                    <div class="auto-container ">
                        <div class="row">
                            <div class="col-lg-6">
                                <img src={require('../../assets/images/shape/y1.png')} alt="" className='marginTop40reverse' />
                            </div>
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <div class="sec-title squrebox">
                                        ...
                                        <p className='font22'>
                                            ...
                                            Through a series of breathing exercises and poses, yoga improves blood flow and helps
                                            you focus your mind. This helps you obtain inner peace and happiness which leads to
                                            better health.
                                        </p>
                                        <p className='font22'>
                                            The yoga therapists at Bridge Health are trained in yogic counseling, lifestyle and
                                            nutrition. They will assist you in developing a yoga regimen which helps you focus on
                                            improving the functionality of your mind, body, and breath.
                                        </p>
