...
<>
    ...
    <img src={require('./../../assets/images/background/mobileteam.png')} alt="" className='imgwidth100 d-lg-none ' />
    <img src={require('./../../assets/images/background/direct.jpg')} alt="" className='imgwidth100 hidemobile' />
    ...
    <div className='d-lg-none'>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2">
                            <div class="displayflex ">
                                <span> <img src={require('../../assets/images/shape/team-mob1.png')} alt=""
                                        class="teamimg" /> </span>
                ...
                <div class="auto-container marginTop50">
                    ...
                    <div class="col-lg-2">
                            {/* <div class="image-wrapper ">
                              ...
                              <div class="displayflex marginleftteam">
                              <span className='teamtext'><b>Swami D Swaminathan</b> <br></br> Director & Co-Founder</span>
                                <span> <img src={require('../../assets/images/shape/team-mob2.png')} alt=""
                                        class="teamimg" /> </span>
                            </div>
                        </div>
                        <div class="col-lg-10">
        ...
        <section class="gallery-section teamleader">
            <div class="auto-container">
                <div class="auto-container">
                    <div class="sec-title textalign martextleft40">
                ...
                <div class="displayflex">
                    <div class="teamflex team-block-one lead1">
                        <div class="column">
                            <div class="leadership">
                                ...
                                <div class="overlay">
                                    ...
                                    <div className='linkdinicon'>
                                        <a href={'https://www.linkedin.com/in/karanverma/'}> <div
                                            class="fab fa-linkedin linkdinicon1"></div></a>
                ...
                <div class="teamflex team-block-one lead2">
                    <div class="column">
                        <div class="leadership">
            ...
            <div class="displayflex marginteam">
                <div class="teamflex team-block-one lead1">
                    <div class="column">
                        <div class="leadership">
                            ...
                            <div class="overlay">
                                ...
                                <div className='linkdinicon'>
                                    <a href={'https://www.linkedin.com/in/bipul-jha-96286110/'}> <div
                                        class="fab fa-linkedin linkdinicon1"></div></a>
                ...
                <div class="column">
                    <div class="leadership">
                        ...
                        <div class="overlay">
                            ...
                            <div className='linkdinicon'>
                                <a href={'https://www.linkedin.com/in/ravishankar-rao-2940858/'}> <div
                                    class="fab fa-linkedin linkdinicon1"></div></a>
            ...
            <div class="column">
                <div class="leadership">
                    ...
                    <div class="overlay">
                        ...
                        <div className='linkdinicon'>
                            <a href={'https://www.linkedin.com/in/pavanba/'}> <div class="fab fa-linkedin linkdinicon1">
                        </div>
                        </a>
        ...
        <div class="column">
            <div class="leadership div-heading">
                ...
                <div class="overlay">
                    ...
                    <div className='linkdinicon'>
                        <a href={'https://www.linkedin.com/in/jayeeta-swar-92b9bb65/'}> <div
                            class="fab fa-linkedin linkdinicon1"></div></a>
    ...
    <div className='hidemobile'>
                        ...
                        <div class="col-lg-10">
                            <div class="author-info">
                                <div class="wrapper-box text">
                                    ...
                                    {/* <div class="text">Senapathy “Kris” Gopalakrishnan served as the Vice Chairman of
                                        Infosys from 2011 to 2014 and the Chief Executive Officer and Managing Director
                                        of Infosys from 2007 to 2011. Kris is one of the co-founders of Infosys. He also
                                        was selected to Thinkers 50, an elite list of global business thinkers, in...
                                    </div> */}
                                </div>
                            </div>
        ...
        <section class="gallery-section teamleader">
            <div class="auto-container">
                ...
                <div class="row">
                    <div class="col-lg-3 team-block-one lead1">
                        <div class="column">
                            <div class="leadership">
                                <img src={require('../../assets/images/gallery/L4.png')} alt="" class="avtar" />
                                <div class="overlay">
                ...
                <div class="col-lg-3 team-block-one lead2">
                    <div class="column">
                        <div class="leadership">
                            <img src={require('../../assets/images/gallery/L1.png')} alt="" class="avtar" />
                            <div class="overlay">
                                ...
                                <div className='linkdinicon'>
                                    {/*
                                    <Link to={'/#'}> <div class="fab fa-linkedin linkdinicon1">
                                </div>
                                </Link> */}
    ...
    <div class="column">
        <div class="leadership">
            ...
            <div class="overlay">
                ...
                <div className='designation1'>VP - Risk Management </div>
                <div className='linkdinicon'>
                    <a href={'https://www.linkedin.com/in/pavanba/'}> <div class="fab fa-linkedin linkdinicon1"></div>
                </a>
    ...
    <div class="col-lg-3 team-block-one lead3">
        <div class="column">
            <div class="leadership div-heading">
                <img src={require('../../assets/images/gallery/L7.png')} alt="" class="avtar" />
                <div class="overlay">
