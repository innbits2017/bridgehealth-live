...
class diet_and_nutrition extends Component {
    ...
    render() {
        const title = "Best clinical Nutritionists In Bangalore - Book Appointment - Bridge Health";
        const description = "Best Nutritionists in Bangalore. Personalized diet and nutrition services. Book  Dietitian Appointment now. Connect with our top nutritionists in Bangalore.";
                ...
                <section class="contact-section">
                    <div class="auto-container">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <img src={require('../../assets/images/shape/nu3.png')} alt="" className='width100 marginTop40reverse' />
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="sec-title squrebox">
                                    ...
                                    <p className='font22'>
                                        ...
                                        Therefore, it’s important to understand that making wise changes in your diet could improve
                                        your health. Having paroper knowledge about which foods to consume and limit or avoid is the
                                        first step in eating healthy.
                                    </p>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="content-box">
                                        <ul className='listicon'>
                                            <li>
                                                Reduce the risk of diseases like diabetes, heart disease, kidney disease,
                                                hypertension, PCOS, and thyroid through diet modification plans
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Maintain a healthy lifestyle and reduce stress levels by including the right
                                                nutrients in meals
                                            </li>
                                        </ul>
                                        <div class="btn-box text-center btn5">
                    ...
                    <div class="auto-container">
                        <div class="row align-items-center reverseFlex">
                            ...
                            <div class="col-lg-6">
                                ...
                                <ul className='listicon'>
                                    <li>
                                        Inclusion of the right mix of macro & micronutrients based on Bridge Health’s nutritional
                                        approach to lower the insulin needed by the body
                                    </li>
                                    <li>
                                        Inclusion of Biota nutrients (prebiotics and probiotics) to strengthen your gut microbiomes
                                    </li>
                                    <li>
                                        Inclusion of natural antioxidants, anti-inflammatory nutrients, and adaptogens to reduce
                                        oxidative stress and inflammation
                                    </li>
                                    <li>
                                        Inclusion of organic, unprocessed & toxin-free ingredients to ensure no harmful additives
                                        enter your system
                                    </li>
                                    <li>
                                        Inclusion of the right amount of all essential nutrients to ensure good health and satisfy
                                        the respective dietary reference intakes.
                                    </li>
                                </ul>
                            </div>
                        </div>
