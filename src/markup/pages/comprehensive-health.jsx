...
class comprehensiveHealth extends Component {
    ...
    render() {
        const title = "Best Comprehensive health check ups in bangalore | Bridge Health";
        const description = "Bridge health offers Comprehensive health checks in Bangalore with all the test under one roof. Our clinical experts have developed a unique health assessment tool which helps determine the right diagnostic tests for you based on your current health status, family history.";
