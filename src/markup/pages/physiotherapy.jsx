                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="sec-title text-center textleft">
                                            <h2 className='textleft'>
                                                <span className='headeingcolorblack'> Improve your </span>
                                                <span className='headeingcolorblue'> mobility </span> <br></br>
                                                <span className='headeingcolorblack'> one step at a time</span>
                                            </h2>
                    ...
                    <div class="auto-container">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="image-wrapper">
                                    <div class="image-one">
                                        <img src={require('../../assets/images/shape/p3.png')} alt="" />
                                    </div>
                                </div>
                            </div>
