...
class dermatology extends Component {
    ...
    render() {
        const title = "Best Dermatology Services in Bangalore |Skin Care - Bridge Health";
        const description = "Book consultations today with the best dermatologists in Bangalore. Our hair, skin, and nails deserve to be treated well. Talk to our dermatologists today for expert care.";
