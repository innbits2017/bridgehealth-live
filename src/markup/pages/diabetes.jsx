...
class diabetes extends Component {
    ...
    render() {
        const title = "Effective Diabetes Care & Prevention in Bangalore - Bridge Health";
        const description = "Bridge health offers best diabetes care services in Bangalore. Highly experienced diabetologist /endocrinologist offer best diabetic care treatments near you.";
                                ...
                                <div class="content-box marginTop40header">
                                    ...
                                    <div class="sec-title text-center textleft">
                                        <h2 className='textleft fontSize50'>
                                            ...
                                            <br></br>
                                            <span className='headeingcolorblue'> More like <span className='diabeates'>Dia<span
                                                className='beat'>beat</span>es</span> </span>
                                        </h2>
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <div class="sec-title squrebox">
                                        ...
                                        <p className='font22'>
                                            Diabetes is a chronic condition that affects millions of people worldwide. If left
                                            untreated or improperly managed, it can lead to a range of complications,
                                            including nerve damage, blindness, kidney disease, and heart disease. Therefore, proper
                                            diabetes care is essential for maintaining good health and preventing these
                                            complications.
                                        </p>
                                    </div>
                        ...
                        <div class="row reverseFlex">
                            <div class="col-lg-6">
                                <div class="contact-form-area">
                                    <div class="sec-title squrebox">
                                        <p className='font22'>
                                            Effective diabetes management involves a lot of steps such as monitoring blood sugar
                                            levels, taking medication as prescribed, following a healthy diet, engaging in regular
                                            exercise, and getting regular check-ups with a healthcare professional.
                                            At Bridge Health, we take an active role in helping you manage diabetes to help you
                                            significantly improve your quality of life and reduce your risk of long-term
                                            complications.
                                        </p>
                                    </div>
                                    <div class="btn-box text-center btn5">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul className='listicon'>
                                    ...
                                    <li>
                                        Regular check-ups and screenings for complications of diabetes, such as eye and kidney
                                        damage
                                    </li>
                            ...
                            <div class="col-lg-6">
                                <ul className='listicon'>
                                    ...
                                    <li>
                                        Treatment and management of related conditions, such as high blood pressure or high
                                        cholesterol
                                    </li>
