...
class nursingAtHome extends Component {
    ...
    render() {
        const title = "Best Home Nursing Services in Bangalore |Nursing at home - Bridge Health";
        const description = "Best nursing at home services in Bangalore. Find Patient Care, home nursing Services near me. Nursing For Senior Citizen. Get contact details, reviews at Bridge health";
                                ...
                                <div class="contact-form-area">
                                    ...
                                    <div class="sec-title squrebox">
                                        ...
                                        <p className='font22'>
                                            ...
                                            Furthermore, bedridden patients need timely care and assistance at all times to perform
                        ...
                        <div class="contact-form-area">
                            ...
                            <div class="sec-title cont-box">
                                ...
                                <p className='font22'>
                                    ...
                                    Our nursing staff is professionally trained to assist all kinds of patients and will see to all
                                    their needs.
                                </p>
                            </div>
                        </div>
