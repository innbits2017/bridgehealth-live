...
class doctor_consults extends Component {
    ...
    render() {
        const title = "Best Doctor Consultation in Bangalore| Book Appointments today - Bridge Health";
        const description = "Book doctor consultation with Bridge health's experienced & skilled medical professionals. Receive Virtual prescription & personalized care for your health concerns & conditions.";
                                ...
                                <div class="content-box marginTop40header">
                                    ...
                                    <div class="sec-title text-center textleft">
                                        <h2 className='textleft fontSize50'>
                                            <span className='headeingcolorblack'>Your doctor is just</span> <br></br> <span
                                                className='headeingcolorblue'>a phone call away </span></h2>
                                        <h3 className='textleft marginTop40'>Schedule a consultation with <br></br> one of our
                                            expert doctors
                                        </h3>
                                    </div>
                ...
                <section>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="sec-title cont-box martobutton">
                            <p className='font22'>
                                All of us get sick at some point in life. And whenever we get sick, we always go to the doctor to
                                find out the reason and get the appropriate medicines so that we can better quickly.
                                In the past, doctor consultations had to be done in the traditional way. You book an appointment,
                                visit the doctor’s office, and get a prescription.
                            </p>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="sec-title squrebox">
                                    <p className='font22'>
                                        The expert doctors at Bridge Health have years of experience as practicing professionals.
                                        You can directly book an appointment with them and avail of virtual consultations with them
                                        wherever you are. This simplifies the process and eliminates the long queue times at the
                                        doctor’s clinic.
                                    </p>
                                </div>
