                    ...
                    <div className="col-lg-8">
                        ...
                        <div>
                            <ul className="job-desc">
                                ...
                                <li>Identifies patient care requirements by establishing personal rapport with patients and their families.</li>
                                <li>Establishes a compassionate environment by providing emotional, psychological, and spiritual support to patients, friends, and families.</li>
                                <li>Assures quality of care by adhering to therapeutic standards, measuring health outcomes against patient care goals and hospital or regulatory standards.</li>
                                ...
                                <li>Protects patients and employees by adhering to infection-control policies and protocols; medication administration and storage procedures; and controlled substance regulations.</li>
                                <li>Documents patient care services by charting in patient and department records.</li>
                                <li>Maintains continuity among nursing teams by documenting and communicating actions, irregularities, and continuing needs.</li>
                                <li>Maintains patient confidence and protects operations by keeping information confidential.</li>
                                <li>Ensures operation of equipment by completing preventive maintenance requirements; calling for repairs; and evaluating new equipment and techniques.</li>
                                <li>Maintains nursing supplies inventory by checking stock to determine inventory level.</li>
                                <li>Maintains professional and technical knowledge by attending educational workshops and participating in professional societies.</li>
                                <li>Maintains a cooperative relationship among health care teams by communicating information and participating in team problem-solving methods.</li>
                        ...
                        <div>
                            ...
                            <p>
                                <strong> For example</strong> The expected incumbent should have exceptional communication skills and ability to derive decisions to present at CEO level. It is also expected that, he/she shall deal with diverse cultures & business segments.
